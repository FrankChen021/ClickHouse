...
NamesAndTypesList HttpClientLogElement::getNamesAndTypes()
{
    ...
    auto http_method_type = std::make_shared<DataTypeEnum8>(
        DataTypeEnum8::Values
        {
            {"GET",         static_cast<Int8>(HttpClientLogEntry::HttpMethod::HTTP_GET)},
            {"POST",        static_cast<Int8>(HttpClientLogEntry::HttpMethod::HTTP_POST)},
            {"DELETE",      static_cast<Int8>(HttpClientLogEntry::HttpMethod::HTTP_DELETE)},
            {"PUT",         static_cast<Int8>(HttpClientLogEntry::HttpMethod::HTTP_PUT)},
            {"HEAD",        static_cast<Int8>(HttpClientLogEntry::HttpMethod::HTTP_HEAD)},
            {"PATCH",       static_cast<Int8>(HttpClientLogEntry::HttpMethod::HTTP_PATCH)},
        }
    );
